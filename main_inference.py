...
parser.add_argument('--pred-save-path', type=str)
parser.add_argument('--data-dir', type=str)
args = parser.parse_args()
model_path = "models/" + args.experiment_name
save_predictions_path = Path("preds/" + args.pred_save_path)
...
if args.single_pdb != "":
    ...
    single_data_dir = Path(f"../case_study/data_CoV-AbDab_search_271121_preprocessed_new/{args.data_dir}/")
    ...
    test_dataset = [load_protein_pair(pdb, single_data_dir,single_pdb=True) for pdb in tqdm(pdb_list)]
